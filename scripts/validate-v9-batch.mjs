...
console.log(`OK: 307/307 fuente; Learning V1 validado; ${over60.length} sesiones no-largas >60 se excluirán operativamente; catálogo fuente bandas 45=${band45}, 60=${band60}.`);
